...
public sealed class WorkspaceRootMappingTests
{
    [Fact]
    public void ResolveFileInputAndToFileUri_MapRootRelativePathToFileUri()
    {
        ...
        var fullPath = workspaceRoot.ResolveFileInput("src/Program.cs");
    ...
    public void UriToRelativePath_MapsLspFileUriToRootRelativePath()
    {
        ...
        var relativePath = workspaceRoot.UriToRelativePath(new Uri(file).AbsoluteUri);
