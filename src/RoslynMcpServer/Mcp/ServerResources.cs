...
public static class ServerResources
{
    ...
    public static string Guide() => """
        ...
        Start with list_workspaces and get_workspace_status, then load a solution or project when needed. Prefer Roslyn semantic tools for navigation. Use get_call_hierarchy on callable positions when you need direct depth-1 incoming callers, outgoing callees, or both. For method-only call graph reviews, pass kindFilter: ["method"]; include "constructor" or "property" only when those edges are relevant.
