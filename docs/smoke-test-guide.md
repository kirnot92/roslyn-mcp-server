...
$env:ASPNETCORE_SYMBOL_RAMP_CHECKPOINTS = "0,10,20,30,40,50,60"
$env:ASPNETCORE_GOTODEF_CHECKPOINTS = "0,10,30,60,120"
$env:POWERSHELL_GOTODEF_CHECKPOINTS = "0,10,30,60,120"
```
